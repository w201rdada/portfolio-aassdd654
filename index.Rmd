...
```{r realestate,echo=FALSE,fig.cap='realestate',fig.align='center',out.width='80%'}
...
```{r intro,echo=FALSE}
#knitr::include_url("https://drive.google.com/file/d/1wtk4QJj5ENwyMR8Fpuq_bwy00N0uNqEI/view?usp=sharing", height = "400px")
embed_url("https://www.youtube.com/watch?v=HMBnB1Ot1Ys")
```
